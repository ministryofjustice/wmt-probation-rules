...
describe('points/domain/location-points-configuration', function () {
  it('throws an error when any property is undefined', function () {
    expect(function () { new LocationPointsConfiguration(undefined, 1, 1, 1, 1, 1, 1) }).to.throw(Error)
    expect(function () { new LocationPointsConfiguration(1, undefined, 1, 1, 1, 1, 1) }).to.throw(Error)
    expect(function () { new LocationPointsConfiguration(1, 1, undefined, 1, 1, 1, 1) }).to.throw(Error)
    expect(function () { new LocationPointsConfiguration(1, 1, 1, undefined, 1, 1, 1) }).to.throw(Error)
    expect(function () { new LocationPointsConfiguration(1, 1, 1, 1, undefined, 1, 1) }).to.throw(Error)
    expect(function () { new LocationPointsConfiguration(1, 1, 1, 1, 1, undefined, 1) }).to.throw(Error)
    expect(function () { new LocationPointsConfiguration(1, 1, 1, 1, 1, 1, undefined) }).to.throw(Error)
  })
