...
describe('points/domain/case-type-weightings', function () {
  it('throws an error when any property is undefined', function () {
    expect(function () { return CaseTypeWeightings(undefined, 1, 1) }).to.throw(Error)
    expect(function () { return CaseTypeWeightings(1, undefined, 1) }).to.throw(Error)
    expect(function () { return CaseTypeWeightings(1, 1, undefined) }).to.throw(Error)
  })
  it('throws an error when any property is a string', function () {
    expect(function () { return CaseTypeWeightings('input', 1, 1) }).to.throw(Error)
    expect(function () { return CaseTypeWeightings(1, 'input', 1) }).to.throw(Error)
    expect(function () { return CaseTypeWeightings(1, 1, 'input') }).to.throw(Error)
  })
  it('doesn\'t throw an error when all the parameters are numbers', function () {
    expect(function () { return CaseTypeWeightings(1, 1, 1) }).to.not.throw(Error)
  })
