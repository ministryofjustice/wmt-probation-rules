...
describe('context-map/om-grade-code', () => {
  describe('valid codes', () => {
    ...
    it('returns DMY grade code when a DMY nDelius code is passed in', () => {
      ...
      expect(filterOmGradeCode('CPQF')).to.equal('DMY')
      ...
      expect(filterOmGradeCode('CRC1')).to.equal('DMY')
      ...
      expect(filterOmGradeCode('PSB')).to.equal('DMY')
      expect(filterOmGradeCode('PS6')).to.equal('DMY')
      expect(filterOmGradeCode('PSR')).to.equal('DMY')
      expect(filterOmGradeCode('PSA')).to.equal('DMY')
      ...
      expect(filterOmGradeCode('PS4')).to.equal('DMY')
